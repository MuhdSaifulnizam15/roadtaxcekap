      ...
      <>
        ...
        {insuranceType === "motor" ? (
          <FormControl alignItems="center" mt="2%">
            ...
            <Select placeholder="Select option" value={coverType}  onChange={handleSelect}>
  ...
  const Form3 = () => {
    ...
    return (
      <>
        ...
        <FormControl display="flex" alignItems="center" mt="2%">
          <Checkbox colorScheme="green" defaultChecked={tnc}>
            I agree to the{" "}
        ...
        <FormControl display="flex" alignItems="center" mt="2%">
          <Checkbox colorScheme="green" defaultChecked={sendThroughWhatsapp}>
